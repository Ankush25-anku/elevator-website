...
export default function Chennai6() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-text">
                Whether you are looking for a compact lift for your home or a
                luxury residential elevator solution, Unosafe delivers
                high-quality installations designed for comfort, safety, and
              ...
              <ul className="bhe-list">
                <li>
                  ISO 9001:2015 Certified – International standards in design,
                ...
                <li>
                  Custom Elevator Solutions – Tailored lifts for homes, offices,
                  hotels, and hospitals.
                </li>
                <li>
                  Preventive Maintenance – Maintenance programs that extend
                  elevator life and reduce breakdowns.
                </li>
                <li>
                  Strict Quality Checks – Every installation undergoes detailed
                  safety inspections.
                </li>
                <li>
                  UNOSAFE Advantage – Close coordination with builders ensures
                  timely installation without compromising safety.
                </li>
              </ul>

              {/* PRICING */}

              <h3 className="bhe-heading">Comprehensive Elevator Solutions</h3>

              <p className="bhe-text">
                Unosafe provides a wide range of elevator solutions designed for
                residential, commercial, and industrial needs across Chennai.
              </p>
              ...
              <h3 className="bhe-heading">UNO Series – Classic to Luxury</h3>
              ...
              <ul className="bhe-list">
                <li>Comfort & Convenience with easy vertical mobility</li>
                <li>
                  Enhanced Property Value with modern elevator installations
                </li>
                <li>Energy Efficient systems designed for low power usage</li>
                <li>Fully Customized Designs suited to your home layout</li>
                <li>Durable elevator systems with long operational life</li>
              </ul>
              ...
              <p className="bhe-text">
                <strong>Can I customize my elevator?</strong>
                <br />
                Yes. Unosafe provides customized cabin interiors, finishes, and
                smart control options designed to match your building design and
                lifestyle.
              </p>
