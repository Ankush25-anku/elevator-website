...
export default function Kerala8() {
  return (
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-text">
                ...
                long-lasting performance for homes across Kerala.
              </p>

              <p className="bhe-text">
                Recognized as one of Asia’s top elevator brands and ranked among
              ...
              <h3 className="bhe-heading">
                Unosafe Home Lifts in Kerala – About Us
              </h3>

              <ul className="bhe-list">
                <li>
                  Trusted residential lift manufacturers with ISO-certified
                  quality standards.
                </li>
                <li>
                  Advanced safety systems ensuring smooth and secure elevator
                  operation.
                </li>
                <li>
                  Innovative designs combining technology, comfort, and
                  elegance.
                </li>
                <li>
                  Professional installation and reliable after-sales service
                  support.
                </li>
                <li>
              ...
              <div className="bhe-priceCard">
                ...
                <p>Cost-effective and reliable residential lift solutions.</p>
              </div>

              {/* VARIANTS */}

              <h3 className="bhe-heading">UNO Elevator Series</h3>

              <ul className="bhe-list">
                <li>UNO CLASSIC – Functional and budget-friendly lifts.</li>
              ...
              <h3 className="bhe-heading">Key Features of Our Home Lifts</h3>

              <ul className="bhe-list">
                <li>Home lift without pit options for easy installation.</li>
                <li>Smooth, silent rides for maximum comfort.</li>
                <li>Compact elevator designs suitable for all home sizes.</li>
                <li>Energy-efficient drive systems with smart automation.</li>
                <li>Customizable cabin interiors and finishes.</li>
                <li>
                  Advanced safety features including emergency alarms and backup
                  power.
                </li>
              </ul>
              ...
              <h3 className="bhe-heading">
                Residential/Home Elevator Installation in Kerala
              </h3>
              ...
              <p className="bhe-text">
                Installation costs depend on lift type, size, and customization.
                We provide clear estimates for the cost of installing a lift in
                your home, ensuring transparency and a smooth installation
                process.
              </p>
