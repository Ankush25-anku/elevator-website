...
export default function UnoClassicExact() {
      ...
      <div className="uce-container">
        ...
        <div className="uce-left">
          ...
          <div className="uce-imageSingle">
            <img src="/assets/images/pro3.jpg" alt="Uno Classic" />
          </div>
          ...
          <ul className="uce-list">
            <li>
              <strong>Cabin :</strong> Mild steel powder coated cabin
            </li>
            <li>
              <strong>Doors :</strong> Mild steel powder coated doors
            </li>
          </ul>
        </div>
