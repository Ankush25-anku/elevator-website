...
export default function Andhra4() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-content">
            ...
            <ul className="bhe-list">
              <li>
                Design Consultation – Our experts evaluate your space and
                recommend the best Elite model, whether it is the sleek X300 or
                a fully customized Bespoke design.
              </li>
              <li>
                Precision Installation – Certified technicians ensure safe and
                flawless installation aligned with Elite’s international
                standards.
              </li>
              <li>
                Tailored Customization – Choose from multiple finishes, panel
                themes, and color palettes to perfectly match your interior
                design.
              </li>
              <li>
                Comprehensive Maintenance – Regular service plans ensure smooth
                elevator performance and fast emergency support.
              </li>
              <li>
                End-to-End Customer Care – From quotation to installation and
                training, Unosafe ensures a seamless customer experience.
              </li>
            </ul>
            ...
            <h3 className="bhe-heading">
              Our Elite Elevator Solutions in Andhra Pradesh
            </h3>

            <p className="bhe-text">
              Unosafe provides a range of Elite elevator solutions designed for
              luxury homes, villas, and modern residential buildings across
              Andhra Pradesh.
            </p>
            ...
            <ul className="bhe-list">
              <li>
                Global Safety Standards – European certifications and advanced
                safety systems ensure maximum reliability.
              </li>
              <li>
                Elegant Modern Design – Stylish cabins designed to complement
                luxury homes and villas.
              </li>
              <li>
                Smart Technology – Intelligent diagnostics and connected
                elevator systems for optimized performance.
              </li>
            </ul>
            ...
            <h3 className="bhe-heading">
              Designed for Modern Homes in Andhra Pradesh
            </h3>
            ...
            <p className="bhe-text">
              ...
              installation, and dependable maintenance support.
            </p>

            <p className="bhe-text">
              With world-class technology, advanced safety standards, and
              customized elevator designs, Unosafe ensures every Elite elevator
              installation enhances both comfort and property value while
              maintaining maximum safety and reliability.
            </p>
