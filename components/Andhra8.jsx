...
export default function Andhra8() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-content">
            ...
            <p className="bhe-text">
              ...
              trusted elevator companies in the region.
            </p>

            {/* WHY BEST */}

            <h3 className="bhe-heading">
              Why We Are the Best Home Lifts Company in Vijayawada
            </h3>

            <ul className="bhe-list">
              <li>
                ISO 9001:2015 Certified manufacturing and service standards.
              </li>
              <li>Trusted nationwide for advanced elevator solutions.</li>
              <li>
                Hundreds of successful installations across Andhra Pradesh.
              </li>
              <li>
                On-time project delivery coordinated with builders and
                homeowners.
              </li>
              <li>Reliable service and long-term maintenance support.</li>
            </ul>

            {/* PRICING */}

            <h3 className="bhe-heading">Our Elevator Products in Vijayawada</h3>

            <p className="bhe-text">
              Unosafe provides a complete range of elevator systems suitable for
              homes, commercial buildings, and industries in Vijayawada.
            </p>

            <div className="bhe-priceCard">
              <h4>Home & Residential Lifts</h4>
              <p>
            ...
            <h3 className="bhe-heading">
              Benefits of Our Home Lifts in Vijayawada
            </h3>

            <ul className="bhe-list">
              <li>Custom interiors and finishes designed for modern homes.</li>
              <li>Flexible cabin sizes suitable for compact spaces.</li>
              <li>Luxury features with smooth and silent ride technology.</li>
              <li>International safety standards for maximum reliability.</li>
              <li>Low maintenance with preventive care programs.</li>
            </ul>

            {/* WHY CHOOSE US */}

            <h3 className="bhe-heading">Home Lifts Price in Vijayawada</h3>

            <p className="bhe-text">
              Elevator prices depend on passenger capacity, lift type, number of
              floors, and customization options. Unosafe ensures transparent
              pricing and premium-quality systems.
            </p>
