...
export default function Chennai1() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-imageCard">
              <img
                src="/assets/images/products/goods-lift-manufacturers-in-chennai.jpg"
                alt="Goods Lift Manufacturers in Chennai"
                className="bhe-image"
              />
            </div>
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-text">
                Chennai’s rapid urbanisation and booming industrial sectors
                demand dependable logistics infrastructure. As buildings grow
                vertically across warehouses, malls, hospitals, factories, and
                residential complexes, the need for efficient goods lifts
                becomes increasingly important for safe and smooth material
                handling.
              </p>
              ...
              <p className="bhe-text">
                ...
                industrial, and residential projects across Chennai.
              </p>

              {/* WHY BEST */}

              <h3 className="bhe-heading">
                Engineering Excellence Across Every Variant
              </h3>

              <ul className="bhe-list">
                <li>
                  Machine Room Elevators – High load capacity and reliable
                  performance for heavy-duty goods movement
                </li>
                <li>
                  Machine Room Less Elevators – Space-efficient traction systems
                  ideal for buildings with limited machine room space
                </li>
                <li>
                  Hydraulic Elevators – Smooth and quiet operation suitable for
                  low to mid-rise buildings
                </li>
                <li>
                  Durable cabin construction designed for industrial and
                  warehouse environments
                </li>
                <li>
                  Reliable vertical transport for materials, equipment, and
                  inventory
                </li>
              </ul>
              ...
              <h3 className="bhe-heading">Goods Lift Price Range in Chennai</h3>

              <p className="bhe-text">
                Goods lift pricing depends on factors such as load capacity,
                number of floors, lift type, and cabin customization. Below are
                typical starting price ranges for different elevator types.
              </p>
              ...
              <ul className="bhe-list">
                <li>
                  UNO CLASSIC – Durable mild steel cabins designed for heavy
                  industrial usage
                </li>
                <li>
                  UNO MAX – Stainless steel cabins with modern matte finish
                </li>
                <li>UNO PRIME – Premium cabins with glass door options</li>
                <li>
                  UNO GOLD – Elegant gold-toned cabins for premium installations
                </li>
                <li>UNO LUXURY – Fully customized high-end elevator systems</li>
              </ul>

              {/* BENEFITS */}

              <h3 className="bhe-heading">Safety and Quality Systems</h3>

              <ul className="bhe-list">
                <li>Safety Management System ensuring regulatory compliance</li>
                <li>Unosafe Express System for rapid quality control</li>
                <li>Runner System for efficient project execution</li>
                <li>
                  Systematized service ensuring reliability and durability
                </li>
                <li>SMS notifications for real-time service updates</li>
                <li>
                  Customer feedback system to continuously improve service
                  quality
                </li>
              </ul>
              ...
              <p className="bhe-text">
                Unosafe focuses on long-term partnerships with clients by
                providing transparent communication, professional installation
                services, and responsive maintenance support.
              </p>

              <p className="bhe-text">
                From initial consultation to post-installation maintenance, our
                team ensures every project runs smoothly. With structured
                communication channels, timely service updates, and continuous
                feedback systems, Unosafe has become a trusted partner for goods
                lift solutions in Chennai.
              </p>
              ...
              <p className="bhe-text">
                As Chennai continues to grow vertically, the need for efficient
                goods transport solutions becomes increasingly critical. Unosafe
                Elevator Pvt. Ltd. delivers high-quality goods lifts designed
                for durability, safety, and operational efficiency. With
                advanced engineering, reliable service support, and multiple
                product variants, we help businesses move goods safely and
                efficiently across every level.
              </p>
            </div>
          </div>
