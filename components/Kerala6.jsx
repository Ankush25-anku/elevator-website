...
export default function Kerala6() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-imageCard">
              <img
                src="/assets/images/products/hydraulic-lift-manufacturers-in-kerala.jpg"
                alt="Hydraulic Lift Manufacturers In Kerala"
                className="bhe-image"
              />
            </div>
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-text">
                ...
                our hydraulic elevators are built to handle heavy loads while
                delivering a comfortable and reliable ride experience.
              </p>

              {/* WHY BEST */}

              <h3 className="bhe-heading">
                Why Choose UNOSAFE Hydraulic Lifts in Kerala
              </h3>

              <ul className="bhe-list">
                <li>
                  Safety First – Advanced safety systems including emergency
                  braking, overload protection, and reliable power backup.
                </li>
                <li>
                  Space-Saving Design – Minimal pit and overhead requirements
                  make installation easier in existing buildings.
                </li>
                <li>
                  Energy Efficient – Hydraulic systems designed for lower power
                  consumption and efficient operation.
                </li>
                <li>
                  Durable & Reliable – Manufactured using high-quality materials
                  for long-lasting performance.
                </li>
                <li>
                  Custom Designs – Stylish cabin interiors and finishes tailored
                  to match building aesthetics.
                </li>
                <li>
                  Smooth Operation – Vibration-free movement ensures comfort for
                  passengers and safe goods transportation.
                </li>
                <li>
                  24/7 Service Support – Dedicated technicians available for
              ...
              <p className="bhe-text">
                Unosafe offers a range of hydraulic elevator solutions designed
                for different building types and operational requirements.
              </p>

              <div className="bhe-priceCard">
                <h4>Passenger Hydraulic Lifts</h4>
                <p>Safe and comfortable elevators for residential buildings</p>
                <p>Smooth travel between floors with advanced safety systems</p>

                <h4>Home Hydraulic Lifts</h4>
                <p>
                  Compact and elegant lifts designed for villas and apartments
                </p>
                <p>Stylish interiors and quiet ride technology</p>

                <h4>Hospital & Goods Hydraulic Lifts</h4>
                <p>
                  Specially designed lifts for patient beds, stretchers, and
                  medical equipment
                </p>
                <p>
                  Heavy-duty goods lifts suitable for industries, warehouses,
              ...
              <h3 className="bhe-heading">
                Why UNOSAFE is the Trusted Name in Kerala
              </h3>

              <ul className="bhe-list">
                <li>Over a decade of experience in elevator manufacturing</li>
                <li>Certified and tested hydraulic elevator systems</li>
                <li>Trusted by architects, builders, and homeowners</li>
                <li>Hundreds of successful lift installations across Kerala</li>
              ...
              <p className="bhe-text">
                ...
                <br />
                Yes. We offer customized cabin finishes, stylish interiors, and
                configurations designed to match your building architecture.
              </p>
