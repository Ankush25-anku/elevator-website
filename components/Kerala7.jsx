...
export default function Kerala7() {
  return (
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-imageCard">
              <img
                src="/assets/images/products/best-elevator-manufacturers-in-kerala.jpg"
                alt="Best Elevator Manufacturers in Kerala"
                className="bhe-image"
              />
            </div>
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-subtitle">
                High-Quality Elevator Solutions for Homes, Apartments, and
                Industries
              </p>
              ...
              <ul className="bhe-list">
                <li>
                  Kerala’s Trusted Brand – Recognized as one of the most
                ...
                <li>
                  Advanced Safety Features – Built with international safety
                  standards for secure and smooth rides.
                </li>
                <li>
                  Energy-Efficient Systems – Eco-friendly technology that
                  reduces power consumption.
                </li>
                <li>
                  Strong After-Sales Support – Local service teams providing
                  prompt maintenance and repair services.
                </li>
              </ul>
              ...
              <ul className="bhe-list">
                ...
                <li>
                  Freight & Goods Lifts – Built to handle heavy loads in
                ...
                <li>
                  Dumbwaiters – Efficient lifts for restaurants, hotels, and
                  service areas.
                </li>
              </ul>
              ...
              <h3 className="bhe-heading">
                Elevator Installation Services in Kerala
              </h3>

              <ul className="bhe-list">
                <li>
                  Site Inspection – Engineers assess building structure and
                ...
                <li>
                  Professional Installation – Safe and precise elevator
                  installation.
                </li>
                <li>
                  Testing & Handover – Strict safety checks before final
                  delivery.
                </li>
              </ul>
