...
export default function Andhra6() {
  return (
      ...
      <div className="bhe-container">
        ...
        <div className="bhe-left">
          ...
          <div className="bhe-content">
            ...
            <ul className="bhe-list">
              <li>
                Comprehensive safety management complying with global standards
              </li>
              <li>Unosafe Express Response for quick issue resolution</li>
              <li>
                Material Dispatch Runner System ensuring timely installation
              </li>
              <li>Real-time SMS updates for maintenance schedules</li>
              <li>Continuous improvement through customer feedback systems</li>
            </ul>

            {/* BENEFITS */}

            <h3 className="bhe-heading">Technical Specifications Snapshot</h3>

            <ul className="bhe-list">
              <li>Passenger Capacity: 6 to 26 persons</li>
              <li>Speed Range: 1.0 m/s to 2.5 m/s</li>
              <li>Cabin Options: Full glass, semi-glass, or designer panels</li>
              <li>Lighting: LED and luxury ceiling lighting options</li>
              <li>
                Customization: Cabin colors, flooring, railing, and control
                panels
              </li>
            </ul>
            ...
            <h3 className="bhe-heading">Installation & Maintenance Support</h3>
            ...
            <p className="bhe-text">
              With Annual Maintenance Contracts (AMC), spare parts availability,
              and 24/7 customer support, we ensure long-term reliability and
              smooth elevator performance for every project.
            </p>
