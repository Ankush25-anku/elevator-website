...
export default function Kerala3() {
  return (
          ...
          <div className="bhe-left">
            ...
            <div className="bhe-content">
              ...
              <p className="bhe-text">
                As the vertical landscape in Kerala continues to evolve—spanning
                residential towers, healthcare facilities, corporate campuses,
                and industrial complexes—reliable and cutting-edge elevator
                solutions are essential. KONE, a global leader known for its
                innovation in safety, sustainability, and smart mobility,
                delivers world-class elevator systems.
              </p>
              ...
              <ul className="bhe-list">
                ...
                <li>
                  ...
                  responsive maintenance, and fast emergency service support.
                </li>
                <li>
              ...
              <h3 className="bhe-heading">
                Our KONE Elevator Offerings in Kerala
              </h3>

              <p className="bhe-text">
                We provide a wide range of KONE elevator solutions designed for
                residential, commercial, and industrial infrastructure across
                Kerala.
              </p>
              ...
              <ul className="bhe-list">
                <li>
                  Safety-First Technology – KONE MonoSpace Smart models with
                  advanced PESSRAL safety systems and programmable electronic
                  safety logic.
                </li>
                <li>
                  Energy Efficiency – EcoDisc® motors and regenerative drives
                  reduce energy usage by up to 30%.
                </li>
                <li>
                  Intelligent Operation – Digital monitoring systems for
              ...
              <h3 className="bhe-heading">Industries We Serve in Kerala</h3>
              ...
              <p className="bhe-text">
                ...
                long-term maintenance support for every KONE elevator system.
                Our certified technicians deliver fully compliant installations
                and efficient service support across Kerala.
              </p>

              <p className="bhe-text">
                Through structured Annual Maintenance Contracts (AMCs),
                scheduled inspections, and 24/7 service support, we ensure
                reliable elevator performance and minimal downtime for every
                project.
              </p>
